...
final class TransactionCell: UITableViewCell {
  ...
  func configure(for model: TransactionDetails) {
    dateLabel.text = model.timestamp?.timestampToStringDate(format: GlobalConstants.shortDateForm)
    typeLabel.text = model.type?.verboseValue
    amountLabel.text = model.cryptoAmount?.coinFormatted
