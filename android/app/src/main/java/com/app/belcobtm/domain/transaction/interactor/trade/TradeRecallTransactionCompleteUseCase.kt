...
class TradeRecallTransactionCompleteUseCase(private val repository: TransactionRepository) :
    ...
    override suspend fun run(params: Params): Either<Failure, Unit> =
        repository.tradeRecallTransactionComplete(params.smsCode, params.coinCode, params.cryptoAmount)

    data class Params(val smsCode: String, val coinCode: String, val cryptoAmount: Double)
}