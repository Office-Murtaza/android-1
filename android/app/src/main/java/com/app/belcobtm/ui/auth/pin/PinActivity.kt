...
//                    enter_code_text.text = getString(R.string.confirm_code)//todo move text to toolbar
                    code.setText("")
...
//            enter_code_text.text = getString(R.string.create_code)//todo move text to toolbar
            mPin1 = null
            code.setText("")
        } else {
            finishAffinity()
