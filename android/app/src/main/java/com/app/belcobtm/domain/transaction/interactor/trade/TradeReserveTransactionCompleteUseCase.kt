...
class TradeReserveTransactionCompleteUseCase(private val repository: TransactionRepository) :
    ...
    override suspend fun run(params: Params): Either<Failure, Unit> =
        repository.tradeReserveTransactionComplete(params.smsCode, params.coinCode, params.cryptoAmount, params.hash)

    data class Params(val smsCode: String, val coinCode: String, val cryptoAmount: Double, val hash: String)
}