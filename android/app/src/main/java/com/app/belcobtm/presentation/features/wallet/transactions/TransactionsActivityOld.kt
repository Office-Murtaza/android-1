...
@RuntimePermissions
class TransactionsActivityOld : BaseMvpActivity<TransactionsContract.View, TransactionsContract.Presenter>(),
    TransactionsContract.View {
    private lateinit var mCoin: CoinModel
    private lateinit var intentCoinItemList: List<CoinDataItem>
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        intentCoinItemList = intent.getParcelableArrayListExtra<CoinDataItem>(KEY_COIN_ARRAY)?.toList() ?: emptyList()
...
//            mPresenter.transactionList,
//            mCoin
//        ) { mPresenter.scrolledToLastTransactionItem() }
...
//            intent.putExtra(TradeActivity.TAG_COIN_ITEM, intentCoinItem)
    ...
    private fun showDepositDialog() {
        intentCoinItemList.find { it.code == mCoin.coinId }?.let {
    ...
    companion object {
        ...
        fun start(context: Context?, coin: CoinModel, coinList: List<CoinModel>) {
            val intent = Intent(context, TransactionsActivityOld::class.java)
