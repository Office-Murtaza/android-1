...
class WelcomePagerAdapter : RecyclerView.Adapter<WelcomePagerAdapter.Holder>() {
    private val itemList: List<WelcomePagerItem> = listOf(
        WelcomePagerItem(R.drawable.ic_welcome_slide1, R.string.welcome_screen_all_assets_in_one_place),
        WelcomePagerItem(R.drawable.ic_welcome_slide2, R.string.welcome_screen_private_and_secure),
        WelcomePagerItem(R.drawable.ic_welcome_slide3, R.string.welcome_screen_buy_sell_and_trade_assets)
    )
