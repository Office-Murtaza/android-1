package com.belcobtm.presentation.features.settings.verification.acuant
...
import com.belcobtm.presentation.features.settings.verification.acuant.face_capture.CameraSourcePreview
import com.belcobtm.presentation.features.settings.verification.acuant.face_capture.FacialGraphic
import com.belcobtm.presentation.features.settings.verification.acuant.face_capture.FacialGraphicOverlay
...
class FacialLivenessActivity : AppCompatActivity(), LiveFaceListener {
    ...
    private fun requestCameraPermission() {
        ...
        Snackbar.make(
            mFacialGraphicOverlay!!, R.string.permission_camera_rationale,
